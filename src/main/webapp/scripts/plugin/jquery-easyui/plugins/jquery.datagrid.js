...
var _datagrid =$.data(_32,"datagrid");
if(!_datagrid) return;
...
if(typeof _182=="string"){
	//添加datagrid判断，用于屏蔽datagrid双击联动时报错
	try{
		var _datagrid = $.data($(this)[0],"datagrid");
		if(_datagrid == undefined) return false;
	}catch(e){
		return false;
	}
...
//----2014--11-18 刘涛    添加只读
if(_1a8 && _1a8.readonly){
	$(_1a9).attr("readonly",_1a8.readonly);
}
if(_1a8 && _1a8.disabled){
	$(_1a9).attr("disabled",_1a8.disabled);
}
