...
var _22=$.extend({title:"",msg:"",closable:true,text:undefined,interval:300},_1f||{});
...
if(_22.closable && _22.title == ""){
var left = win.parent().width() - 13;
var $close = $('<div style="position: absolute;cursor: pointer; z-index: 10; top:0px;left:'+left+'px;"><img style="width:13px;height:13px;" src="'+ ctx + '/scripts/plugin/jquery-easyui/themes/' + skin  + '/icons/ext/processer_close.png"/><div>');
win.parent().append($close);
$close.click(function(){win.window("close")});
}
win.find("div.messager-p-msg").html(_22.msg);
var bar=win.find("div.messager-p-bar");
bar.progressbar({text:_22.text});
win.window({closable:_22.closable,onClose:function(){
if(this.timer){
