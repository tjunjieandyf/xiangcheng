...
opts.tab.append("<a href=\"javascript:void(0)\" class=\"tabs-inner\">"+"<span class=\"tabs-title\"></span>"+"<span class=\"tabs-icon\"></span>"+"</a><em></em>");
...
if(type=="body"){
//用原始的js方法来获得对象，这样写可以防止特殊符号获取对象出错
var tr= $(document.getElementById($.data(_836,"datagrid").rowIdPrefix+"-"+_837+"-"+id));
if(!tr.length){
