...
<%
	...
	request.setAttribute("startTime", startTime+" "+SHOUR);
	
	String endTime = request.getParameter("endTime");
	request.setAttribute("endTime", endTime+" "+EHOUR);
...
<div class="px-pop" style="overflow: hidden;   overflow-y: scroll;" id="app">
    <div class="px-item px-message" style="display:none;">
    ...
    <div class="px-map-big" v-show="regionType=='outside'" style="height: 890px;background: none;display:none; ">
    ...
    <!-- <div class="px-item px-conclusion" v-show="regionType=='inside'" style="display:none; ">
    ...
    <div class="raster" v-show="regionType=='inside'">
        <div class="row">
            <div class="col col-7" style="left: 20%;">
                <div class="px-item">
                    <h3>空气质量及气象参数变化趋势</h3>
